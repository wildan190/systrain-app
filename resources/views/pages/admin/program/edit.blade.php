<x-layouts.app title="Edit Program">
    <div class="flex flex-col gap-4 p-6">
        <div class="flex justify-between items-center">
            <h1 class="text-3xl font-semibold text-gray-900 dark:text-white">✏️ Edit Program</h1>
        ...
        <div class="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
            <form id="edit-form" action="{{ route('program.update', $program->id) }}" method="POST" class="space-y-4">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="number" name="batch" value="{{ $program->batch }}"
                        class="w-full border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-800 rounded-lg p-2 focus:ring-2 focus:ring-blue-500"
                        required>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="peserta" value="{{ $program->peserta }}"
                        class="w-full border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-800 rounded-lg p-2 focus:ring-2 focus:ring-blue-500"
                        required>
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_mulai" value="{{ $program->tanggal_mulai }}"
                        class="w-full border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-800 rounded-lg p-2 focus:ring-2 focus:ring-blue-500"
                        required>
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_selesai" value="{{ $program->tanggal_selesai }}"
                        class="w-full border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-800 rounded-lg p-2 focus:ring-2 focus:ring-blue-500"
                        required>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="harga" value="{{ $program->harga }}"
                        class="w-full border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-800 rounded-lg p-2 focus:ring-2 focus:ring-blue-500"
                        required>
                </div>
